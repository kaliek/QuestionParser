...
outOfVocabularyTokenOption = "title"
...
# def main():
#     wrg = "Wht's the American dllar equvalent for 8 pouds in the U.K. ?"

    
#     tokensCorrect = nltk.word_tokenize(wrg)
#     tokens = [token.lower() for token in tokensCorrect]   
#     print(getTrueCase(tokens))
